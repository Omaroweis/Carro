...
public class Carro {
	...
	public String toString() {
		if(this.Isligado) {
			 return (this.marca + " " + this.modelo + " " + this.placa + " " + ", esta a " + this.getVelocidadeKmH() + " KM/H" + " Com combustivel = "+ this.combustivel + "L,  E está " +  "Ligado. O status da marcha eh: " + this.marcha.toString());
		}
		return  (this.marca + " " + this.modelo + " " + this.placa + " " + ", esta a " + this.getVelocidadeKmH() + " KM/H" + " Com combustivel = "+ this.combustivel + "L,  E está " + "Desligado. O status da marcha eh: " + this.marcha.toString());
	}
